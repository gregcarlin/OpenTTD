...
static const StringID _landscape[]   = {STR_CONFIG_SETTING_LAND_GENERATOR_ORIGINAL, STR_CONFIG_SETTING_LAND_GENERATOR_TERRA_GENESIS, STR_CONFIG_SETTING_LAND_GENERATOR_CONTINENTS, INVALID_STRING_ID};
